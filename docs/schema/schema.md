## <a name="resource-user">JSON Web Token for User Management</a>
...
### JSON Web Token for User Management Create
...
### JSON Web Token for User Management Update
...
### JSON Web Token for User Management 

edit_user_registration delete
